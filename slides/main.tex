...
\input{literature-review/manyparticle-entanglement}
...
\input{literature-review/mq-nmr-experiment}
\input{literature-review/mq-nmr-coherences-distribution}
...
\input{literature-review/model-equivalent-spins}
\input{literature-review/mq-nmr-mq-hamiltonian-diagonalization}
\input{many-particle-entanglement-in-nanopore}

\section{Многочастичная запутанность в квазиодномерных цепочках}
\input{literature-review/model-uniform-spin-chain}
\input{literature-review/model-zigzag-spin-chain}
