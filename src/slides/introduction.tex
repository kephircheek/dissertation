...
\note{
  ...
  и доказал что вероятность определенного исхода такого эксперимента в классическом случае не может превышать определенного значения. 
  ...
  В 2008 году группа во главе с Цайлингер проводит полномаштабный эксперимент, который снова подтверждает нелокальный характер квантовой теории.
...
\end{frame}
\note{
  Буквально месяц назад произошло знаменательное событие. 
...
\end{frame}
\note{
  Раз такие состояния существуют, возникает естественный интерес исследовать процеесы связанные с этим явлением, а также конструировать устройства использующие такие являеня. Тема модная и 
