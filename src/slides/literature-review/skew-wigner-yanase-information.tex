...
\end{frame}
\note{
    Косая информация была введена Вигнером и Янасе в контексте квантовых измерении в качестве меры информации,
    содержащейся в векторе квантового состояния, лежащего под углом по отношению к наблюдаемой $A$. 
    ...
    Например, ее можно интерпретировать как квантовую неопределенность наблюдаемой $A$.
    ...
    Позже я покажу к каким интересным результатам он приводит. 
