...
что если квантовая информация Фишера системы $N$ частиц
%
...
\begin{wrapfigure}{O}{0.5\textwidth}
  \includegraphics[width=0.5\textwidth]{result-nanopore-eq-nent-by-beta.pdf}
...
При температуре $T = {4.8\cdot10^{-2}}$~K $(\beta=0.5)$ на Рис.~\ref{fig:result-nanopore-eq-m2-by-time-beta0.5} видна полоса, в которой неравенство~(\ref{eq:qfi-entanglement-criteria}) может быть удовлетворено, когда $14 \leq k \leq 27$.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.3\textwidth}
    ...
    \caption{\protect\input{figures/result-nanopore-do-m2-by-time-beta1}}
  ...
  \begin{subfigure}[t]{0.3\textwidth}
    ...
    \caption{\protect\input{figures/result-nanopore-do-m2-by-time-beta2}}
  ...
  \begin{subfigure}[t]{0.3\textwidth}
    ...
    \caption{\protect\input{figures/result-nanopore-do-m2-by-time-beta3}}
...
Этого достаточно для передачи МК когерентностей вдоль цепочки~\cite{Bochkin2018qip} и создания запутанности между удаленными концами цепочки~\cite{Lazarev2019}.
...
\begin{figure}[H]
  ...
  \caption{
    ...
    \subref{fig:result-zchain-nent-by-beta-n8-n6}) температуры $\beta$
    в зигзагообразной цепочке,
...
Зависимость максимального измеренного размера запутанного кластера от температуры в зигзагообразной цепочке,
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \includegraphics[width=\linewidth]{result-nanopore-eq-nent-by-beta-qfi-wyi.png}
	\caption{}
	\label{fig:result-nanopore-eq-nent-by-beta-qfi-wyi}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.49\textwidth}
    \includegraphics[width=\linewidth]{result-zchain-nent-by-beta-qfi-wyi.png}
	\caption{}
